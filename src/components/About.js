            ...
            <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
                        Hafa adai, I'm Ida. <span className="font-large wave">👋🏽</span>
                        <br className="hidden lg:inline-block" />I'm a full-stack web developer.
                    </h1>

                    <p className="mb-8 leading-relaxed">
                    With my passion for learning and exploring, I have a Bachelors of Science in Geology, Masters of Science in Environmental Science, and a certification for Full Stack Web Development. Let's work together!
                    </p>
                ...
                <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                    <img className="object-cover object-center rounded-full" alt="hero" src="./images/crop.jpg"/>
                </div>
            </div>
        </section>
    );
